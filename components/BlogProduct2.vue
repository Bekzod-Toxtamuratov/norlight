...
<template>
	<div class="container mt-[100px]">
		...
		<div v-else>
			...
			<nuxt-link to="/blog">
				<button
					class="hover:translate-x-4 md:hidden border w-full text-center mt-5 border-black rounded-full p-5 px-6 text-sm justify-center items-center flex gap-1 h-3 hover:bg-[#FF58065B] hover:text-white"
				>
					Перейти в блог
					<svg
						width="15"
