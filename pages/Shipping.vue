	...
	<div>
		<div class="container  max-md:mb-[2px]">
			...
			<div class="md:flex gap-x-[102px] justify-center">
				<div class="md:w-[45%]">
					<h1
						class="font-bold md:leading-[70px] text-[28px] md:text-[64px] mb-9"
					>
						Доставка и оплата
					</h1>
				</div>
				<div class="md:w-[55%]">
					<h2 class="font-semibold text-xl md:text-2xl">Доставка</h2>
					<p
						class="md:text-[20px] text-[16px] max-md:max-w-[328px] leading-5 md:leading-7 font-normal mt-8"
					>
					...
					<!-- ************************** -->
					<h2 class="font-semibold text-xl md:text-2xl mt-8">
						Курьерская доставка
					</h2>
					<p
						class="md:text-[20px] text-[16px] max-md:max-w-[328px] leading-5 md:leading-7 font-normal mt-8"
					...
					<h2 class="font-semibold text-xl md:text-2xl mt-8">Самовывоз</h2>
					<p
						class="md:text-[20px] text-[16px] leading-5 max-md:max-w-[310px] md:leading-7 font-normal mt-8 mb-[116px]"
					>
		...
		<div class="max-md:my-20  w-full border md:px-[100px] mb-[116px] h-[400px] md:h-[672px]">
			<iframe
